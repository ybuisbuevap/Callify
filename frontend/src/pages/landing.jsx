...
//     <rect x="56" y="228" width="80" height="4" rx="2" fill="#4f8ef7" opacity="0.8"/>
...
//     <rect x="278" y="170" width="86" height="66" rx="8" fill="none" stroke="#4f8ef7" strokeWidth="1.5" opacity="0.5"/>
...
//     <rect x="246" y="253" width="28" height="22" rx="6" fill="#4f8ef7" opacity="0.15"/>
//     <rect x="251" y="257" width="18" height="13" rx="3" fill="none" stroke="#4f8ef7" strokeWidth="1.2"/>
//     <path d="M251 270 L256 275 L256 270" fill="#4f8ef7" opacity="0.6"/>
//     <rect x="270" y="20" width="110" height="28" rx="8" fill="#1c1c21" stroke="#2a2a30" strokeWidth="1"/>
...
//     <rect x="32" y="212" width="60" height="4" rx="2" fill="#4f8ef7" opacity="0.6"/>
//     <rect x="32" y="221" width="96" height="4" rx="2" fill="#2a2a30"/>
//     <rect x="32" y="230" width="76" height="4" rx="2" fill="#2a2a30"/>
//     <path d="M36 252 L28 262 L50 252" fill="#1c1c21" stroke="#2a2a30" strokeWidth="1"/>
//     {[0,1,2,3,4,5].map(row =>
...
//   },
//   joinBtn: {
//     flex: 1, padding: '0.65rem', background: '#4f8ef7',
